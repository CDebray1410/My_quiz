...
--
-- Host: localhost:3306
-- Generation Time: May 14, 2021 at 09:54 AM
...
('DoctrineMigrations\\Version20210505101916', '2021-05-05 12:19:31', 87),
('DoctrineMigrations\\Version20210507154057', '2021-05-07 17:41:01', 82),
('DoctrineMigrations\\Version20210510083248', '2021-05-10 10:33:04', 86),
('DoctrineMigrations\\Version20210510085008', '2021-05-10 10:50:22', 271),
('DoctrineMigrations\\Version20210510090357', '2021-05-10 11:04:01', 255),
('DoctrineMigrations\\Version20210512090453', '2021-05-12 11:05:08', 209),
('DoctrineMigrations\\Version20210512091127', '2021-05-12 11:11:30', 362),
('DoctrineMigrations\\Version20210512132021', '2021-05-12 15:20:25', 91),
('DoctrineMigrations\\Version20210512132422', '2021-05-12 15:24:46', 130);
...
(110, 18, 'Question test'),
(111, 18, 'Deuxieme question test');

-- --------------------------------------------------------

--
-- Table structure for table `quizz_history`
--
...
CREATE TABLE `quizz_history` (
  ...
  `id_categorie` int NOT NULL,
  `date_passed` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `quizz_history`
--

INSERT INTO `quizz_history` (`id`, `id_user`, `score`, `number_of_questions`, `id_categorie`, `date_passed`) VALUES
(2, 2, 10, 10, 4, '12-05-2021 15:25:50'),
(3, 2, 10, 10, 1, '12-05-2021 16:00:00'),
(4, 2, 2, 10, 10, '12-05-2021 16:11:37'),
(5, 2, 6, 10, 9, '12-05-2021 16:12:19'),
(6, 2, 5, 10, 8, '12-05-2021 16:12:49'),
(7, 14, 10, 10, 1, '12-05-2021 16:32:50'),
(8, 14, 7, 10, 3, '12-05-2021 16:33:05'),
(9, 14, 1, 10, 7, '12-05-2021 16:33:26'),
(10, 15, 5, 10, 8, '12-05-2021 16:36:44');
...
(2, 'jeremy@gmail.com', '[\"ROLE_ADMIN\"]', '$argon2id$v=19$m=65536,t=4,p=1$6wK/rEllLicz/OYYY3oPkw$3jxXX6uwmvLsl+C0WJH4VRX+/0TnhCFuKZdByrvJ6oQ', 1),
(10, 'test@gmail.com', '[]', '$argon2id$v=19$m=65536,t=4,p=1$ASnBw/1DWdxSq7pgvjtdtg$cAkSQM0rKqDnc2Ty9MyVR4sAI07FeMY2Lrm7a+sud2o', 1),
(14, 'christopherdebray@outlook.fr', '[\"ROLE_ADMIN\"]', '$argon2id$v=19$m=65536,t=4,p=1$ze1wKX5rypaw8GCreQwaug$4Jsa69Z6cKxI4bhahWjO25IGUJkIpprd1JyTDLU+XX4', 1),
(15, 'aurelien@outlook.fr', '[]', '$argon2id$v=19$m=65536,t=4,p=1$i68mLrY9WhvzDMjN9qbP8g$U54/CfkB4cHa3YRZ39thmn7mzFNGAmepYfztcZa70fk', 1);
...
--
-- Indexes for table `quizz_history`
--
...
--
-- AUTO_INCREMENT for table `quizz_history`
--
ALTER TABLE `quizz_history`
...
--
-- Constraints for table `quizz_history`
--
ALTER TABLE `quizz_history`
